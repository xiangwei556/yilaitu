...
import { LeftPanel } from './components/background-generation/LeftPanel';
import { RightPanel } from './components/model-generation/RightPanel';

export const BackgroundGeneration: React.FC = () => {
