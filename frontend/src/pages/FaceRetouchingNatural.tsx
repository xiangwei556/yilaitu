...
import { LeftPanel } from './components/face_retouching_natural/LeftPanel';
import { RightPanel } from './components/model-generation/RightPanel';

export const FaceRetouchingNatural: React.FC = () => {
    ...
    if (generationParams) {
      const tempRecord = {
        ...
        params: {
          ...
          selectedModelTab: generationParams.selectedModelTab,
          selectedCategory: generationParams.selectedCategory,
          selectedModelIndex: generationParams.selectedModelIndex
        },
        model_id: 2,
        model_name: '模特换脸',
