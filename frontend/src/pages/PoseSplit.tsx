...
import { LeftPanel } from './components/pose_split/LeftPanel';
import { RightPanel } from './components/model-generation/RightPanel';

export const PoseSplit: React.FC = () => {
    ...
    if (generationParams) {
      const tempRecord = {
        ...
        params: {
          ...
          selected_poses: generationParams.selected_poses,
          pose_tab: generationParams.pose_tab
        },
        model_id: 2,
        model_name: '姿势裂变',
