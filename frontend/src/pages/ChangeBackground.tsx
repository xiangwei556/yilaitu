...
import { LeftPanel } from './components/change_background/LeftPanel';
  ...
  const handleGeneratedData = (images: string[], taskId: string, generationParams?: any) => {
    ...
    if (generationParams) {
      const tempRecord = {
        ...
        params: {
          uploaded_images: generationParams.uploaded_images,
          selected_background: generationParams.selected_background
        },
        model_id: 1,
        model_name: '换背景',
